    ...
    <div className="w-full px-4 lg:px-8">
      ...
      <div className="space-y-4 mb-5 flex flex-col items-center p-8 border text-justify  shadow xl:text-lg text-gray-800">
        ...
        <p className="max-w-lg italic text-sm text-gray-500">
          While it is possible* to use these with other cameras, you will not
          get the camera match profiles which are exclusive to the GR lineup.
          These profiles drastically affect the look of the image.
        </p>
      </div>
